...
const App = () => {
  ...
  const editionDrop = useEditionDrop("0xa94476e98903232FCa7e58d281AA1b52D1EB12BD");
  // // Esse é o endereço do nosso contrato ERC-20 do nosso token.
  const token = useToken("0x40A9Df7c7Fd4e72d718fA1564DD748Dc16bBFb29");
  // Nosso contrato de votação.
  const vote = useVote("0xC166c3F0666587e86AA12d526e5085858A28C8cf");
  ...
  if (!address) {
    return (
      <div className="landing">
        <h1>🎌BJJ DAO🥋</h1>
        <h3>A PRIMEIRA COMUNIDADE DESCENTRALIZADA FOCADA NO JIU-JITSU BRASILEIRO</h3>
  ...
  if (hasClaimedNFT) {
    return (
      <div className="member-page">
        <h1>🥋 Página dos membros da BJJ DAO🤘</h1>
        <p>Parabéns por fazer parte da comunidade de Jiu-Jitsu Brasileiro!</p>
        <div>
          <div>
  ...
  return (
    <div className="mint-nft">
      <h1>Bem-vindos à BJJ DAO</h1>
      <h2>Cunhe gratuitamente seu NFT de membro 🥋 da BJJ DAO</h2>
      <h3>A DAO da comunidade Brasileira de Jiu-Jitsu</h3>
